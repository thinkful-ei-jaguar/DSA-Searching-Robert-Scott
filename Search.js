...
function main2() {
  ...
  tree2.insert(8); //picard
  tree2.insert(6); //riker
  tree2.insert(5); //worf
  tree2.insert(4); //security-officer
  tree2.insert(7); //laForge
  tree2.insert(12); //data
  tree2.insert(15); //crusher
  tree2.insert(13); //selar
  tree2.postorder();
}
...
//   array.push(tree.key);
//   if(tree.left) {
//     nextOfficer(tree.left);
//   }
//   if(tree.right) {
//     nextOfficer(tree.right);
//   }  
// }
